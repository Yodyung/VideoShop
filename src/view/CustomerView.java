...
public class CustomerView extends JPanel 
{
	...
	public void connectDB(){
		...
		try {
			model=new CustomerDaoImpl();		//기본 생성자에 DB연결 설정해 놓아서 생성자 부르기.
		} catch (Exception e) {
			System.out.println("고객 관리 드라이버 로딩 실패 : "+e.getMessage());
			//e.printStackTrace();	-밑의 콘솔창에 어디서 어떻게 오류가 나는지 좌르륵 나옴
		}
